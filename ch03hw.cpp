...
int main()
{
    const int MAX_ITEMS = 10; //Set array and limit
    string inventory[MAX_ITEMS];

    int backpackItems = 0; //Added three items to start
    ...
    inventory [1] = "EmptyMapSling"; //Change in inventory

    cout << "\n-You grab the map.-\n" << endl;
    Sleep (2000);

    cout << "Your inventory is now: " << endl; //Change in inventory
    for (int i = 0; i < backpackItems; ++i)
    {
        if (inventory[i] != "")
        {
    ...
    cin >> inventory[backpackItems++]; //Player names first item gained

    Sleep (3000);
    cout << "\nYour inventory is now: " << endl; //Change in inventory
    for (int i = 0; i < backpackItems; ++i)
    {
        if (inventory[i] != "")
        {
    ...
    cin >> inventory[backpackItems++]; //Player names second gained item
    ...
    string playerInput; //Player searches for an item
    cin >> playerInput;

    if(inventory[2] == playerInput || playerInput == "cookies") //If correct then item is retrieved
        {
            Sleep (2000);
        ...
        else //Player doesn't type the item in the inventory then they don't retrieve item
        {
            cout << "\nOh so you decided to do nothing. It's no problem let's continue on." << endl;
        }

    cout << "\nHere is your inventory now: " << endl; //Change in inventory
    for (int i = 0; i < backpackItems; i++)
    {
        if (inventory[i] != "")
        {
    ...
    cin >> inventory[backpackItems++]; //Player names third item
    ...
    inventory [1] = "TownMap"; //Item is returned back into inventory
    ...
    string playerInput2; //Player must search this last item to give
    cin >> playerInput2;
    ...
    for (int i = 0; i < backpackItems; i++) //Change in inventory
    {
        if (inventory[i] != "")
        {
            cout << i + 1 << ". " << inventory[i] << endl;
    ...
    Sleep (4000);
    cout << "\nMaybe all of the trouble was worth it." << endl; //End of the adventure
